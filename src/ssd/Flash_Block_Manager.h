...
namespace SSD_Components
{
	...
	public:
		...
		void Invalidate_subpage_in_block(const stream_id_type streamID, const NVM::FlashMemory::Physical_Page_Address& address);
		...
		void Invalidate_subpage_in_block_for_preconditioning(const stream_id_type streamID, const NVM::FlashMemory::Physical_Page_Address& address);
