...
#define All_VALID_PAGE 0x0000000000000000ULL
	...
	*/
	...
	public:
		...
		Block_Pool_Slot_Type* Get_a_free_block_b(stream_id_type stream_id, bool for_mapping_data);
	...
	public:
		...
		virtual void Invalidate_subpage_in_block(const stream_id_type streamID, const NVM::FlashMemory::Physical_Page_Address& address) = 0;
		...
		virtual void Invalidate_subpage_in_block_for_preconditioning(const stream_id_type streamID, const NVM::FlashMemory::Physical_Page_Address& address) = 0;
